...
--   raw_requests        untouched Socrata payload, rolling 30 days
...
-- Kept so a validation-rule change can be replayed against real payloads
-- without re-fetching, and so "the upstream schema changed" is provable.
-- ---------------------------------------------------------------------------
